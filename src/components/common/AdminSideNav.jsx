...
const AdminSideNav = ({ isSideNavOpen, toggleSideNav }) => {
  ...
  return (
    <div className={`${isSideNavOpen ? 'flex' : 'hidden'} absolute md:relative top-[10vh] md:top-0 bottom-0 w-[60%] md:w-[25%] flex-col gap-6 bg-[#12143d] text-white text-xl py-10 shadow-md no-scrollbar overflow-auto`}>
