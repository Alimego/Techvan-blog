...
const WriterSideNav = ({ isSideNavOpen, toggleSideNav }) => {
  ...
  return (
    <div className={`${isSideNavOpen ? 'flex' : 'hidden'} absolute z-20 md:relative top-[10vh] md:top-0 bottom-0 w-[60%] md:w-[25%] flex-col gap-6 bg-[#12143d] text-white text-xl py-10 shadow-md no-scrollbar overflow-auto`}>
        <Link to={'/writer-dashboard'}>
          <div className={`hover:bg-[#aaaef02d] px-10 py-2 ${activeItem === '/writer-dashboard' ? 'bg-[#aaaef05d]' : ''}`}>
            Dashboard
          </div>
        </Link>
      
        <Link to={'/writer-dashboard/create'}>
          <div className={`hover:bg-[#aaaef02d] px-10 py-2 ${activeItem === '/writer-dashboard/create' ? 'bg-[#aaaef05d]' : ''}`}>
            Create Post
          </div>
        </Link>
      
        <Link to={'/writer-dashboard/posts'}>
          <div className={`hover:bg-[#aaaef02d] px-10 py-2 ${activeItem === '/writer-dashboard/posts' ? 'bg-[#aaaef05d]' : ''}`}>
            Posts
          </div>
        </Link>
