    ...
    <div className="pt-20 pb-6 px-6 md:px-20">
      ...
      <div>
        <p className="text-[17px] flex flex-col gap-3 font-[Lato]">
          ...
          <p>Our vision is to become a leading platform that inspires the next generation of tech lovers, innovators, and curious minds. Whether you’re a professional in the industry or just someone who enjoys keeping up with the latest advancements, Alimego is here to make sure you never miss a beat.</p>
